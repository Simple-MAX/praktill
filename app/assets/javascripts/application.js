...
(function ($) {
    ...
    ------------------------------------ */
    $(function () {
        const $pl_btns = $('.pl-btn').on('click', function () {
    ...
    if ($('div').hasClass('portfolio-area')) {
        distance = $('.portfolio-area').offset().top;
    ...
    if ($('div').hasClass('h2-who-we-area')) {
        distance = $('.h2-who-we-area').offset().top;

        $(window).on('scroll', function () {
            const top_distance = $(window).scrollTop() + -200;
            if (top_distance >= distance) {
    ...
    $('#container').imagesLoaded(function () { //image loaded
        ...
        // masonary activation
        const $grid = $('.grid_container').isotope({
            itemSelector: '.grid',
...
// filter items on button click
    ...
    function h2_testimonial_carousel() {
        const owl = $(".h2-testimonial-carousel");
        owl.owlCarousel({
            loop: true,
            margin: 30,
            responsiveClass: true,
    ...
    $('form#cf button#submit').on('click', function () {
        ...
        if (fname !== '' && email !== '' && msg !== '') {
            const values = "fname=" + fname + "&subject=" + subject + "&email=" + email + " &msg=" + msg;
            $.ajax({
                type: "POST",
                url: "mail.php",
                data: values,
